...
// Package secret provides SecretRef, a secret-bearing configuration value that is
// either a literal or a scheme-prefixed reference (env:, file:, literal:) resolved
// to its concrete value on demand. It is a small, dependency-free primitive so any
// package or module can reference secrets without depending on a larger consumer.
package secret
