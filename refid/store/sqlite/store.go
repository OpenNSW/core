...
// database/sql and raw SQL — no ORM. Import a SQLite driver (e.g.
// modernc.org/sqlite, which is pure Go — no CGO), open a connection with
// sql.Open, and pass the resulting *sql.DB to New or NewRandom.
//
